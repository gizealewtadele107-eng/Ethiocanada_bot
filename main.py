...
# --- 1. የስህተት መከታተያ (Logging) ማስተካከያ ---
# ይህ በ Render Logs ላይ ቦቱ ለምን እንዳልሰራ ዝርዝር መረጃ ያሳየናል
logging.basicConfig(
...
# --- 2. ቦቱ ሳይዘጋ በRender ላይ ንቁ ሆኖ እንዲቆይ (Keep-Alive) ---
app = Flask('')
...
# --- 3. ዋና ቅንብሮች (TOKEN & ADMIN ID) ---
TOKEN = "8971919038:AAEDbX6BS8zPUQg5AgE0Wag5uiu0eTXpLu0"
...
# --- 5. ዋና ማውጫ እና የተጠቃሚ ገጽ ቁልፎች ማስተናገጃ ---
...
async def admin_callback(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if action == "verify":
        ...
        if u:
            success_msg = f"🎉 **እንኳን ደስ አለዎት! ምዝገባዎ በአድሚን ተረጋግጧል።** ✅"
            try:
...
# የቴሌግራም ሲስተም የውስጥ ስህተት ከፈጠረ እዚህ ጋር ይመዘገባል
...
if __name__ == '__main__':
    ...
    logger.info("Ethio-Canada Bot is starting polling...")
